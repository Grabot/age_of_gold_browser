...
export async function validateToken(accessToken: string): Promise<LoginResponse> {
...
export async function logoutUser(accessToken: string): Promise<ApiResponse<unknown>> {
...
export async function loginTokenGoogle(accessTokenGoogle: string): Promise<LoginResponse> {
...
export async function resetPassword(newPassword: string, accessToken: string): Promise<boolean> {
...
export async function deleteAccount(accessToken: string): Promise<ApiResponse<unknown>> {
...
export async function deleteAccountRequest(email: string): Promise<ApiResponse<unknown>> {
	return await makeRequest<boolean>({
		method: 'POST',
...
export async function confirmDeleteAccount(accessToken: string): Promise<ApiResponse<unknown>> {
	return await makeRequest<boolean>({
		method: 'DELETE',
